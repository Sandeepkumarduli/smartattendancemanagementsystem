...
class Student:
    def __init__(self, root):
        ...
        img = Image.open(r"C:\Users\SANDE\Desktop\Smart Attendence System\college_images\2213.jpg")
        img = img.resize((500, 130), Image.LANCZOS)  # Use Image.LANCZOS filter
        ...
        img1 = Image.open(r"C:\Users\SANDE\Desktop\Smart Attendence System\college_images\2213.jpg")
        img1 = img1.resize((500, 130), Image.LANCZOS)  # Use Image.LANCZOS filter
        ...
        img2 = Image.open(r"C:\Users\SANDE\Desktop\Smart Attendence System\college_images\2213.jpg")
        img2 = img2.resize((500, 130), Image.LANCZOS)  # Use Image.LANCZOS filter
        ...
        img3 = Image.open(r"C:\Users\SANDE\Desktop\Smart Attendence System\college_images\2213.jpg")
        img3 = img3.resize((1366, 768), Image.LANCZOS)  # Use Image.LANCZOS filter
        ...
        title_lb1 = Label(bg_img,text="STUDENT PANNEL",font=("poppins",30,"bold"),bg="green",fg="black")
        title_lb1.place(x=0,y=0,width=1366,height=45)
        
        main_frame = Frame(bg_img,bd=2,bg="white") #bd mean border 
        main_frame.place(x=5,y=55,width=1355,height=510)
        #left
        left_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="STUDENT DETAILS",font=("poppins",12,"bold"),fg="black")
        ...
        year_combo["values"]=("Select Year","2017","2018","2019","2020","2021")
        ...
        #right
        right_frame = LabelFrame(main_frame,bd=2,bg="white",relief=RIDGE,text="STUDENT DETAILS",font=("poppins",12,"bold"),fg="black")
    ...
    def add_data(self):
        if self.var_dep.get()=="Select Department" or self.var_course.get=="Select Course" or self.var_year.get()=="Select Year" or self.var_semester.get()=="Select Semester" or self.var_std_id.get()=="" or self.var_std_name.get()=="" or self.var_div.get()=="" or self.var_roll.get()=="" or self.var_gender.get()=="" or self.var_dob.get()=="" or self.var_email.get()=="" or self.var_mob.get()=="" or self.var_address.get()=="" or self.var_teacher.get()=="":
            ...
            try:
                conn = mysql.connector.connect(username='root', password='Sandy@3246',host='localhost',database='studentdatabase',port=3306)
                mycursor = conn.cursor()
                mycursor.execute("insert into student values(%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s,%s)",(self.var_std_name.get(),
                self.var_dep.get(),
                self.var_course.get(),
                self.var_year.get(),
    ...
    def generate_dataset(self):
      if self.var_dep.get() == "Select Department" or self.var_course.get() == "Select Course" or self.var_year.get() == "Select Year" or self.var_semester.get() == "Select Semester" or self.var_std_id.get() == "" or self.var_std_name.get() == "" or self.var_div.get() == "" or self.var_roll.get() == "" or self.var_gender.get() == "" or self.var_dob.get() == "" or self.var_email.get() == "" or self.var_mob.get() == "" or self.var_address.get() == "" or self.var_teacher.get() == "":
        ...
        try:
            ...
            self.var_std_id.set(id + 1)  # Assign the new ID to var_std_id
            ...
            try:
                while True:
                    ...
                    if face_cropped(my_frame) is not None:
                        ...
                        file_path = f"Data/user.{id}.{img_id}.jpg"  # Use f-string to include variables
                        cv2.imwrite(file_path, face)
                        cv2.putText(face, str(img_id), (10, 10), cv2.FONT_HERSHEY_COMPLEX, 2, (0, 255, 0), 2)
